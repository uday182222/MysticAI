...
export function AiChatInterface() {
  ...
  const handleDownloadChat = async () => {
    ...
    try {
      ...
      const filename = generateReportFilename('ai-chat');
      
      // Generate PDF from the hidden report component
      await generatePDF('ai-chat-report', { filename });

      toast({
        title: "PDF Report Downloaded!",
        description: `Your conversation with ${messages.length} messages has been saved as a beautiful PDF`,
      });
